...
def parse_option():
    ...
    parser.add_argument('--num_init_classes', type=int, default=10,
    ...
    parser.add_argument('--learning_rate', type=float, default=0.01,
                        help='learning rate')
    parser.add_argument('--lr_decay_epochs', type=str, default='50, 150',
    ...
    parser.add_argument('--dataset', type=str, default='cifar100',
                        choices=['cifar10', 'cifar100', 'tinyimgnet', 'mnist'], help='dataset')
    ...
    opt.model_name = 'SupCE_{}_{}_lr_{}_decay_{}_bsz_{}'.\
        ...
        if (idx + 1) % opt.print_freq == 0:
            print('Train: [{0}][{1}/{2}]\t'
                  ...
                  'acc {top1.val:.3f} ({top1.avg:.3f})'.format(
                   ...
                   data_time=data_time, loss=losses, top1 = top1))                # 'Acc@1 {top1.val:.3f} ({top1.avg:.3f})'   , top1=top1
            #print("acc", acc, "ueq", ueq)
            sys.stdout.flush()
