...
from angle_similar_ce import RKAngle
...
def parse_option():
    ...
    parser.add_argument('--num_init_classes', type=int, default=80,
    ...
    opt.model_name_new = '{}_Relation_{}_class_{}_{}_lr_{}_epochs_{}_bsz_{}_temp_{}_alfa_{}_mem_{}_incremental'.\
    ...
    opt.model_name_old = '{}_Relation_{}_class_{}_{}_lr_{}_epochs_{}_bsz_{}_temp_{}_alfa_{}_mem_{}_incremental/last.pth'.\
...
def train(train_loader, model_old, model_new, criterion, optimizer, epoch, opt, old_targets):
    ...
    for idx, (images, labels) in enumerate(train_loader):
        ...
        # compute loss
        prediction_new = model_new(images)
        loss_cls = criterion_cls(prediction_new, labels)

        features_old = model_old.encoder(images)
        features_new = model_new.encoder(images)
        
        loss_similar = criterion_destill(features_new, features_old, labels, old_targets)
